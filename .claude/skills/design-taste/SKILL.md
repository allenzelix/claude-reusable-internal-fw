...
> Vendored from h3nryprod01/design-taste (merged synthesis of
> emilkowalski/skill, pbakaus/impeccable, leonxlnx/taste-skill). See
> upstream repo for updates. Mixed-license package — see `LICENSE`,
> `NOTICE`, and `LICENSES/Apache-2.0.txt` in this folder.
